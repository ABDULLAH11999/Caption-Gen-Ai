...
export class LandingPage {
  ...
  renderPlans() {
    ...
    const plansToRender = this.plans.length > 0 ? this.plans : [
      { id: 'free', name: 'Free Starter', price: 0, billing_cycle: 'month', short_desc: 'Perfect for casual creators starting out with viral captions.', features: [{ text: '3 Video captions per day', included: true }, { text: 'All 16 viral presets', included: true }, { text: 'Whisper AI transcription', included: true }, { text: '60 FPS GPU acceleration', included: false }] },
      { id: 'creator-pro', name: 'Creator Pro', price: 19, billing_cycle: 'month', short_desc: 'For YouTubers, TikTokers & agencies seeking maximum watch time.', features: [{ text: '50 Video captions per day', included: true }, { text: 'Full Customizer Studio', included: true }, { text: 'Smooth 60 FPS 1080p Export', included: true }, { text: 'AI Video Quality Boost (HD+)', included: true }] },
